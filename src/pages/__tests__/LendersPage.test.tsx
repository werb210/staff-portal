...
describe("LendersPage", () => {
  ...
  it("creates an active lender and shows it as Active", async () => {
    ...
    await userEvent.type(screen.getByLabelText(/Submission email/i), "submit@example.com");
  ...
  it("loads persisted lender fields in the edit modal", async () => {
    ...
    expect(screen.getByLabelText(/Submission email/i)).toHaveValue("submit@example.com");
